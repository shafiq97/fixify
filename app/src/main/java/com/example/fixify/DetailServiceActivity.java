    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.nextButton).setOnClickListener(v -> {
            ...
            if (currentUser == null) {
                ...
                Toast.makeText(DetailServiceActivity.this, "Need to login before booking service", Toast.LENGTH_SHORT).show();
            } else {
                // User is logged in, proceed to the next activity
                Intent nextIntent = new Intent(DetailServiceActivity.this, TimeSlot.class);
