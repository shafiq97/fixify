...
public class PaintingServiceAdapter extends RecyclerView.Adapter<PaintingServiceAdapter.ServiceViewHolder> {
    ...
    public PaintingServiceAdapter(List<PaintingService> paintingServiceList, Context context) {
